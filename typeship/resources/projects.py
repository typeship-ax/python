...
class ProjectsResource:
    ...
    def update(
        ...
        *,
        ...
        A `502 follow_up_failed` means the Project was saved, but an obsolete Draft pull request
        could not be retired. Retrieve the Project and retry the same update to finish retiring
