...
class ProjectsResource:
    ...
    def update(self, project_id: ProjectId, *, name: Optional[str] = None, spec_url: Optional[str] = None, source: Optional[Source] = None, outputs: Optional[List[OutputId]] = None, packages: Optional[Packages] = None, auto_regen: Optional[bool] = None, spec_patches: Optional[List[SpecPatch]] = None, mcp_enabled: Optional[bool] = None, relay_enabled: Optional[bool] = None, config: Union[Optional[Config], UnsetType] = UNSET, request_options: Optional[RequestOptions] = None) -> Project:
        """Update a project
...
class AsyncProjectsResource:
    ...
    async def update(self, project_id: ProjectId, *, name: Optional[str] = None, spec_url: Optional[str] = None, source: Optional[Source] = None, outputs: Optional[List[OutputId]] = None, packages: Optional[Packages] = None, auto_regen: Optional[bool] = None, spec_patches: Optional[List[SpecPatch]] = None, mcp_enabled: Optional[bool] = None, relay_enabled: Optional[bool] = None, config: Union[Optional[Config], UnsetType] = UNSET, request_options: Optional[RequestOptions] = None) -> Project:
        """Update a project
